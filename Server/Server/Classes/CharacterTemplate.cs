...
namespace Server.Classes
{
    public class CharacterTemplate
    {
        ...
        public CharacterTemplate(CharacterTemplate chr)
        {
            this.id                 = chr.Id                    ;
        ...
        public CharacterTemplate(int id, string nationality, string birthCountry, string deathCountry, string livingCountry, string birthPlace, string deathPlace, string livingPlace, string religious, string firstName, string secondName, string lastName, string biography, string photo, DateTime birthDate, DateTime deathDate)
        {
            this.id = id;
